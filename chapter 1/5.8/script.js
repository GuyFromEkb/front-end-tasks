...
// UPD догадывался что нужно использовать WeakSet , но как это всё реализовывается и нормально работает, я очень туго понимаю, полез в ответы....для эта тема - сложная
...
// UPD аналогично с предведущим примером, перечитал статью пару раз, вроде да что -то понял, но сложно...